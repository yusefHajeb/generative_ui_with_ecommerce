...
// import '../../providers/ai_chat_providers.dart';
// import '../widgets/chat_data_display.dart';
// import '../widgets/chat_data_display.dart';
...
//           child: Image.asset('assets/m2p_logo.png', fit: BoxFit.contain),
//         ),
//         title: const Text('M2P Nexa'),
//         actions: [
//           IconButton(
...
//                         ),
//                         const Gap(16),
//                         Text('Ask me anything!', style: Theme.of(context).textTheme.titleLarge),
//                         const Gap(8),
//                         Text(
//                           'I can help you navigate, check balances,\nview transactions, and more.',
...
//                         ),
//                         const Gap(24),
//                         // const ProactiveSuggestionsWidget(),
//                       ],
//                     ),
//                   )
//                 : ListView.builder(
...
//                 ),
//                 child: Text(
//                   'DEBUG: type=${message.data!.type}, hasContent=${message.data!.content != null}, len=${(message.data!.content as String?)?.length ?? 0}',
...
//         final setting = arguments['setting'] as String;
//         final value = arguments['value'] as String;
//         ref.read(settingsProvider.notifier).updateSetting(setting, value);
//         break;
//     }
//   }
// }
